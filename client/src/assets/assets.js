...
export const dummyTestimonial = [
    {
        ...
        role: 'TOPIK II Trung Cấp 4',
        image: 'https://duhocies.edu.vn/wp-content/uploads/elementor/thumbs/Trong.visa_-pfslfd4hoeort0ns0kulmxq26m9ne13zi7sawfiibo.jpg',
        rating: 5,
        feedback: 'Học tiếng Hàn online hả? Lúc đầu máu lửa lắm, xong nhiều khi thấy oải kinh khủng vì một mình một góc. Được cái chủ động, rảnh lúc nào học lúc đấy. Mấy cái app học cũng thú vị, nhưng mà nhiều khi cũng hơi "ảo". Nói chung là cũng vui có, nản có, nhưng mà nghĩ đến lúc nói được tiếng Hàn thì lại cố tiếp. Chắc ai học online cũng thế nhỉ?  ',
    },
    {
        name: 'Minh Tân',
        role: 'TOPIK 1 Sơ Cấp 1',
        image: 'https://duhocies.edu.vn/wp-content/uploads/elementor/thumbs/visa-Nguyen-Tan-Phong-da-sua-pfslfgvufqtx3gibemh3wwrwk5r48tiwuqe8tjcxms.jpg',
        rating: 5,
        feedback: 'Dạo này mỗi hôm em làm một đề đọc topik. Bằng mọi giá tháng 3 năm sau em phải có thấp nhất bằng topik 3 để lên chuyên ngành.',
    },
    {
        name: 'Thu Trang',
        role: 'TOPIK II Cao cấp 5',
        image: 'https://duhocies.edu.vn/wp-content/uploads/elementor/thumbs/Linh.visa_-pfslepmixjslqrlwtsoxelnjbzhh1lip2zh5wihcn8.jpg',
        rating: 5,
        feedback: 'Em rất vui vì khoảng thời gian qua IES đã đồng hành cùng em trên con đường học tập tiếng Hàn. Từ 1 đứa lơ ngơ chưa biết định hướng để học tập, em đã từng bước chinh phục được thứ tiếng này. Thật sự đây là niềm vui rất lớn đối với em. Cảm ơn thầy cô, các anh chị trợ giảng đã nhiệt tình và hết mình giúp đỡ em. Chúc IES ngày càng phát triển và thành công hơn nữa! ',
    },
];
